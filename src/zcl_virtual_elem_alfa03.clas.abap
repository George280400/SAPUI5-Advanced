CLASS zcl_virtual_elem_alfa03 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_virtual_elem_alfa03 IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    DATA lt_original_data TYPE STANDARD TABLE OF z_c_travel_alfa03 WITH DEFAULT KEY.
