...
CLASS lhc_Supplement IMPLEMENTATION.
  ...
  METHOD calculateTotalSupplPrice.
    ...
    IF NOT keys IS INITIAL.
      zcl_aux_travel_det_alfa03=>calculate_price( it_travel_id = VALUE #( FOR GROUPS <booking> OF booking_key IN keys
...
CLASS lsc_supplement IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    DATA: lt_supplements TYPE STANDARD TABLE OF zbooksupp_alfa03,
