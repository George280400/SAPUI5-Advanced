CLASS zcl_aux_travel_det_alfa03 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED z_i_travel_alfa03,
           tt_booking_reported     TYPE TABLE FOR REPORTED z_i_booking_alfa03,
           tt_supplements_reported TYPE TABLE FOR REPORTED z_i_booksupp_alfa03.
...
CLASS zcl_aux_travel_det_alfa03 IMPLEMENTATION.
